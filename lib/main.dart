...
void main() async {
  ...
  // Firebase and Airtable are optional — don't block the app on them.
  try {
    await FcmService.initialize();
  } catch (e) {
    debugPrint('FCM init skipped: $e');
  }
  // Fire-and-forget so the app never waits on this network call
  Future.microtask(() => AirtableService.fetchAirtableRecords().catchError((e) {
    debugPrint('Airtable prefetch skipped: $e');
  }));
  runApp(
    MultiProvider(
      providers: [
