...
class _RecitersScreenState extends State<RecitersScreen> {
  ...
  final Map<String, List<Map<String, String>>> _recitersData = {
    'hawamdya': [
      { 'id': 'h1', 'name': 'الشيخ حمدي أبو الدهب', 'server': 'mock' },
      { 'id': 'h2', 'name': 'الشيخ محمود عبدالسلام', 'server': 'mock' },
      { 'id': 'h3', 'name': 'الشيخ محمد حسني', 'server': 'mock' },
      { 'id': 'h4', 'name': 'الشيخ محمد جمعة', 'server': 'mock' },
      { 'id': 'h5', 'name': 'الشيخ حنفي محمود', 'server': 'mock' },
      { 'id': 'h6', 'name': 'الشيخ عبدالرحمن مصطفى', 'server': 'mock' }
    ],
    'egypt': [
      { 'id': 'e1', 'name': 'محمد صديق المنشاوي - مرتل 🇪🇬', 'server': 'https://server10.mp3quran.net/minsh/' },
      { 'id': 'e2', 'name': 'محمد الطبلاوي - مجود 🇪🇬', 'server': 'https://server12.mp3quran.net/tblwy_mjod/' },
      { 'id': 'e3', 'name': 'أحمد نعينع - مجود 🇪🇬', 'server': 'https://server11.mp3quran.net/na3na_mjod/' },
      { 'id': 'e4', 'name': 'عبدالله كامل - مرتل 🇪🇬', 'server': 'https://server16.mp3quran.net/kamal/' },
      { 'id': 'e5', 'name': 'عبدالباسط عبدالصمد - مرتل 🇪🇬', 'server': 'https://server7.mp3quran.net/basit/' },
      { 'id': 'e6', 'name': 'عبدالباسط عبدالصمد - مجود 🇪🇬', 'server': 'https://server13.mp3quran.net/basit_mjod/' },
      { 'id': 'e7', 'name': 'محمود خليل الحصري - مرتل 🇪🇬', 'server': 'https://server13.mp3quran.net/husr/' },
      { 'id': 'e8', 'name': 'محمود خليل الحصري - مجود 🇪🇬', 'server': 'https://server12.mp3quran.net/husr_mjod/' },
      { 'id': 'e9', 'name': 'محمود علي البنا - مرتل 🇪🇬', 'server': 'https://server8.mp3quran.net/banna/' },
      { 'id': 'e10', 'name': 'أحمد محمد عامر - مرتل 🇪🇬', 'server': 'https://server10.mp3quran.net/a_amer/' }
    ],
    'saudi': [
      { 'id': 's1', 'name': 'محمد علي الحذيفي - مرتل 🇸🇦', 'server': 'https://server9.mp3quran.net/hudhaify/' },
      { 'id': 's2', 'name': 'أحمد العجمي - مرتل 🇸🇦', 'server': 'https://server10.mp3quran.net/ajm/' },
      { 'id': 's3', 'name': 'سعد الغامدي - مرتل 🇸🇦', 'server': 'https://server7.mp3quran.net/s_gmd/' },
      { 'id': 's4', 'name': 'سعود الشريم - مرتل 🇸🇦', 'server': 'https://server7.mp3quran.net/shur/' },
      { 'id': 's5', 'name': 'عبدالرحمن السديس - مرتل 🇸🇦', 'server': 'https://server11.mp3quran.net/sds/' },
      { 'id': 's6', 'name': 'ماهر المعيقلي - مرتل 🇸🇦', 'server': 'https://server12.mp3quran.net/maher/' },
      { 'id': 's7', 'name': 'محمد أيوب - مرتل 🇸🇦', 'server': 'https://server8.mp3quran.net/ayoub/' },
      { 'id': 's8', 'name': 'ناصر القطامي - مرتل 🇸🇦', 'server': 'https://server11.mp3quran.net/qtm/' },
      { 'id': 's9', 'name': 'ياسر الدوسري - مرتل 🇸🇦', 'server': 'https://server11.mp3quran.net/yasser/' }
    ]
  };
        ...
        children: [
          ...
          Column(
            children: [
              ...
              // Reciters List View — wide buttons
              Expanded(
                            ...
                            child: Row(
                              children: [
                                ...
                                Container(
                                  ...
                                  height: 36,
                                  decoration: BoxDecoration(
                                    color: const Color(0xFF0B4C35).withOpacity(isDark ? 0.4 : 0.08),
                                ...
                                // Arrow on left (end in RTL)
                                Icon(
                                  Icons.arrow_back_ios,
                                  size: 16,
                                  color: isDark
                                      ? const Color(0xFFD4AF37).withOpacity(0.7)
                                      : const Color(0xFF0B4C35).withOpacity(0.4),
                                ),
                              ],
                            ),
                          ),
  ...
  void _showSurahSelector(Map<String, String> reciter) async {
    final bool isOnline = await NetworkHelper.isConnected();
    if (!isOnline && mounted) {
      NetworkHelper.showNoInternetDialog(
        context,
        title: 'الاستماع يتطلب إنترنت',
        message: 'يتطلب الاستماع إلى تلاوات القراء وجود اتصال نشط بالإنترنت لتشغيل الصوتيات بجودة عالية. يرجى التأكد من اتصال هاتفك بالإنترنت والمحاولة مجدداً.',
      );
      return;
    }
